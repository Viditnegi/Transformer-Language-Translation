...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def forward(self, q, k, v, mask):
        ...
        # makes sense to cut along the embedding dimension because each of the d_model(512) value represent some feature of the word and each head sees the word with different angles  /meanings.
